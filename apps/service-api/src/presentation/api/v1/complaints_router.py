...
async def create_complaint(
    ...
    complaint = await complaint_service.create_complaint(db, user_id=user.user_id, data=data)
    return complaint
...
async def update_complaint_status(
    ...
    try:
        complaint = await complaint_service.update_complaint_status(db, complaint_id=complaint_id, data=data)
